...
<? if ($arResult["FORM_TYPE"] == "login") : ?>
  ...
  <div id="login-info">
    ...
    ?>
    <img src="<?= SITE_TEMPLATE_PATH ?>/images/punkt_top.gif" border="0" alt="">&nbsp;&nbsp;<a href="<?= $arResult["AUTH_REGISTER_URL"] ?>" onclick="return ShowLoginForm();"><?= GetMessage("AUTH_LOGIN_BUTTON") ?></a>&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?= SITE_TEMPLATE_PATH ?>/images/punkt_top.gif" border="0" alt="">&nbsp;&nbsp;<a href="<?= $arResult["AUTH_REGISTER_URL"] ?>"><?= GetMessage("AUTH_REGISTER") ?></a>
  </div>
<? else : ?>
  <div id="login-info">
