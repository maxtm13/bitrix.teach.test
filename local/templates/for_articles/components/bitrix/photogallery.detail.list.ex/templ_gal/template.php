...
<div id="photo-more-photo-link-cont-<?= $ucid?>" class="photo-show-more">
	...
	<a id="photo-more-photo-link-<?= $ucid?>" href="javascript:void(0);" title="<?= GetMessage("P_SLIDER_MORE_PHOTOS_TITLE")?>"><img class="strelka" src="/local/templates/test_template/images/ukaz_l.gif"><?= GetMessage("P_SLIDER_MORE_PHOTOS")?><img class="strelka" src="/local/templates/test_template/images/ukaz_r.gif"></a>
</div>
<?endif;?>
         </td>
     </tr>
