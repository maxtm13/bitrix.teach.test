...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "N",
		"COMPONENT_TEMPLATE" => "my_sections",
		"DETAIL_URL" => "",
		"DISPLAY_BOTTOM_PAGER" => "Y",
		"DISPLAY_DATE" => "Y",
		"DISPLAY_NAME" => "Y",
		...
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array(0=>"ALL",1=>"ATT_email",2=>"ATT_adress",3=>"ATT_REGION",4=>"ATT_site",5=>"ATT_Phone",6=>"",),
		...
		"SECTION_PROPERTY_CODE" => array(0=>"SORT",1=>"NAME",2=>"",),
		"SECTION_SORT_BY1" => "ID",
